...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--train_img_dir', default='../../dataset/elec_chip/train_img', help='dataset')
    parser.add_argument('--train_xml_dir', default='../../dataset/elec_chip/train_xml', help='dataset')
    parser.add_argument('--val_img_dir', default='../../dataset/elec_chip/val_img', help='dataset')
    parser.add_argument('--val_xml_dir', default='../../dataset/elec_chip/val_xml', help='dataset')
    return parser
...
def main(args):
    ...
    print('*************',num_classes)
    # dataset = Electric(args.train_img_dir,args.train_xml_dir,get_transform(True, args.data_augmentation),)
    # dataset_test = Electric(args.val_img_dir,args.val_xml_dir,get_transform(False, args.data_augmentation),)
    # num_classes=2
